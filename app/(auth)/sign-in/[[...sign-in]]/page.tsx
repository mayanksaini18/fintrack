      ...
      <SignIn
        appearance={{
          elements: {
            ...
            formFieldInput: 'border border-zinc-200 dark:border-white/[0.08] bg-zinc-50 dark:bg-white/[0.04] rounded-xl h-11 text-zinc-900 dark:text-white focus:ring-2 focus:ring-white/20 focus:border-white/20 transition-all',
            formButtonPrimary: 'bg-zinc-900 hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-100 dark:text-zinc-900 rounded-xl h-11 text-sm font-semibold transition-colors shadow-none text-white',
            footerAction: 'text-sm',
            footerActionLink: 'text-zinc-700 dark:text-zinc-300 font-medium hover:text-zinc-900 dark:hover:text-white',
            footer: 'bg-transparent',
            identityPreview: 'border border-zinc-200 dark:border-white/[0.08] rounded-xl bg-zinc-50 dark:bg-white/[0.04]',
            formFieldAction: 'text-zinc-700 dark:text-zinc-300 text-xs font-medium',
            alert: 'rounded-xl',
